...
public class WelcomeScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Deklarasi dan Menginisialisasi variable nama dengan Label Nama dari Layout WelcomeScreen */
        ...
        findViewById(R.id.button_Lanjutkan).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
